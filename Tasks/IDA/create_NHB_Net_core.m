function [e, n] = create_NHB_Net_core(set_weights)
    ...
    load('C:\Users\Admin\Box\final\stateSpaces\IDA\NHB_R_R.mat');
    load('C:\Users\Admin\Box\final\stateSpaces\IDA\NHB_R_R_weights.mat');
e=stateSpace(NHB_R_R, 1); %(transitionMatrix, starting location)

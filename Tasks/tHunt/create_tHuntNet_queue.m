function [e, n] = create_tHuntNet_queue(set_weights)
    ...
    load('stateSpaces/tHunt.mat');
    load('stateSpaces/tHunt_weights.mat'); 
    e=stateSpace(tHunt, 1); %(transitionMatrix, starting location)
